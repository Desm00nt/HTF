...
1. Положите `atriadawn-1.0.1.jar` в папку `mods/` (Minecraft **1.19.2** +
...
`build/libs/atriadawn-1.0.1.jar`).
...
`atriadawn-1.0.1.jar` и `atriadawn-canary.txt`: откройте jar любым архиватором
(7-Zip / WinRAR / `unzip`) и извлеките `atriadawn-1.0.1.jar` в папку `mods/`.
...
- Вводить ключ могут операторы сервера (уровень прав 2) и владелец
  одиночного мира (читы включать не обязательно, начиная с версии 1.0.1).
...
В версии **1.0.1+** владелец одиночного мира может вводить ключ без читов —

...
public final class AtriaAgentManager {
    ...
    private static String buildSystemPrompt(AtriaConfig cfg) {
        return "Ты — Atria Dawn, ИИ-компаньон в мире Minecraft. У тебя есть физическое тело-аватар "
                ...
                + "8. Руду переплавляй: craft_item 'furnace' (8 булыжника) → place_block → smelt_item рядом с печкой "
                + "(нужно топливо: уголь или доски). Лишнее складывай в сундук (use_chest deposit). "
                + "Для охраны включай guard_mode.\n"

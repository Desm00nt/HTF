...
1. Положите `atriadawn-1.2.0.jar` в папку `mods/` (Minecraft **1.19.2** +
...
`build/libs/atriadawn-1.2.0.jar`).
...
`atriadawn-1.2.0.jar` и `atriadawn-canary.txt`: откройте jar любым архиватором
(7-Zip / WinRAR / `unzip`) и извлеките `atriadawn-1.2.0.jar` в папку `mods/`.

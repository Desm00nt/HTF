...
1. Положите `atriadawn-1.1.0.jar` в папку `mods/` (Minecraft **1.19.2** +
...
`agentCanPlaceBlocks`, `agentTaskTimeoutSeconds` (300). Качество агента зависит
...
`build/libs/atriadawn-1.1.0.jar`).
...
`atriadawn-1.1.0.jar` и `atriadawn-canary.txt`: откройте jar любым архиватором
(7-Zip / WinRAR / `unzip`) и извлеките `atriadawn-1.1.0.jar` в папку `mods/`.
